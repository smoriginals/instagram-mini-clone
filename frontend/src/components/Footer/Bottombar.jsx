    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 h-14 bg-white border-t flex justify-around items-center z-50">
            ...
            <Drawer>
                ...
                <DrawerContent
                    className="fixed inset-0 h-screen w-screen p-0 rounded-none bg-white text-black"
                >
                    ...
                    {/* Username */}
                    <div className="mt-4 text-center flex justify-start items-center gap-2 px-2">
                        <p className="text-lg font-semibold tracking-wide">username_here</p>
                    </div>

                    {/* Story Photo */}
                    <div className="mt-4 w-full h-[80vh] flex justify-center">
                        <img
